<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand ms-4" href="#">
        <img class="" src="/asset/DoneIT.png" width="150px" alt="">
      </a>
      ...
      <div class="d-flex justify-content-evenly w-75" id="navbarSupportedContent">
        ...
        <form class="d-flex me-4">
          <input class="rounded-start" style="font-family: 'Inter', sans-serif;" type="search" placeholder="What IT service you looking for? . . ." aria-label="Search">
